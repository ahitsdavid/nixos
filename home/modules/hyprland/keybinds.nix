...
in
{
  ...
  wayland.windowManager.hyprland.extraConfig = ''
    ...
    bindd = $mod, Tab, Toggle overview, global, quickshell:overviewWorkspacesToggle # Toggle overview
    ...
    bindid = , Super_L, Toggle overview, global, quickshell:searchToggleRelease # Toggle overview/launcher
    ...
    bind = $mod, V, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Period, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Tab, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, A, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, N, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Slash, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, K, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, M, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, C, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Return, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, T, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, W, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+CONTROL, F, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Space, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Left, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Right, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Up, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Down, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, bracketleft, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, bracketright, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Q, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+SHIFT, Left, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+SHIFT, Right, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+SHIFT, Up, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+SHIFT, Down, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+SHIFT, Space, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, F, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, D, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, P, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 1, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 2, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 3, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 4, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 5, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 6, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 7, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 8, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 9, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, 0, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+CONTROL, Right, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+CONTROL, Left, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Page_Down, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, Page_Up, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+CONTROL, Page_Down, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+CONTROL, Page_Up, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, S, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 1, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 2, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 3, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 4, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 5, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 6, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 7, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 8, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 9, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, 0, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+ALT, S, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+SHIFT, A, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+SHIFT, T, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, minus, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, equal, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, semicolon, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, apostrophe, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, XF86AudioMute, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+CONTROL+ALT, R, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod, L, global, quickshell:searchToggleReleaseInterrupt # [hidden]
    bind = $mod+SHIFT, L, global, quickshell:searchToggleReleaseInterrupt # [hidden]
