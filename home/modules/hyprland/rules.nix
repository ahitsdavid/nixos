  ...
  wayland.windowManager.hyprland = {
    settings = {
      ...
      layerrule = [
        ...
        "anim_style slide left, match:namespace sideleft.*"
        "anim_style slide right, match:namespace sideright.*"
        ...
        "anim_style slide, match:namespace quickshell:bar"
        "anim_style fade, match:namespace quickshell:screenCorners"
        "anim_style slide right, match:namespace quickshell:sidebarRight"
        "anim_style slide left, match:namespace quickshell:sidebarLeft"
        "anim_style slide bottom, match:namespace quickshell:osk"
        "anim_style slide bottom, match:namespace quickshell:dock"
        ...
        "anim_style fade, match:namespace quickshell:notificationPopup"
