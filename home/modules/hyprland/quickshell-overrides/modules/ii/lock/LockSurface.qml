...
MouseArea {
    ...
    // Added to fix black lock screen - wallpaper is rendered directly
    // in the lock surface since WlSessionLockSurface blocks other layers
    ...
    Rectangle {
        ...
        GaussianBlur {
            ...
            // Scale for extra zoom effect
            transform: Scale {
                origin.x: blurEffect.width / 2
                origin.y: blurEffect.height / 2
                xScale: Config.options.lock.blur.extraZoom
                yScale: Config.options.lock.blur.extraZoom
            }
        }
