 ...
 *
 * PATCHED: Uses custom get_keybinds.py that properly handles bindd commands
 */
Singleton {
    id: root
    // Use our patched script from ~/.local/share/quickshell/scripts
    property string keybindParserPath: FileUtils.trimFileProtocol(`${Directories.home}/.local/share/quickshell/scripts/get_keybinds.py`)
